...
Two leftovers this cannot reach without breaking that signature: the renderer
processes still appear as `Electron Helper` in Activity Monitor, and the bundle
ID stays `com.github.Electron`.
